 ...
 *     },
 * }
 * @psalm-type RecranetTwigSpreadsheetConfig = array{
 *     pre_calculate_formulas?: bool|Param, // Disabling formula calculations can improve the performance but the resulting documents won't immediately show formula results in external programs. // Default: true
 *     cache?: array{
 *         bitmap?: scalar|Param|null, // Using a bitmap cache is necessary, PhpSpreadsheet supports only local files. // Default: "%kernel.cache_dir%/spreadsheet/bitmap"
 *         xml?: scalar|Param|null, // Using XML caching can improve memory consumption by writing data to disk. Works only for .xlsx and .ods documents. // Default: false
 *     },
 *     csv_writer?: array{ // See PhpOffice\PhpSpreadsheet\Writer\Csv.php for more information.
 *         delimiter?: scalar|Param|null, // Default: ","
 *         enclosure?: scalar|Param|null, // Default: "\""
 *         excel_compatibility?: bool|Param, // Default: false
 *         include_separator_line?: bool|Param, // Default: false
 *         line_ending?: scalar|Param|null, // Default: "\n"
 *         sheet_index?: int|Param, // Default: 0
 *         use_bom?: bool|Param, // Default: false
 *     },
 * }
 ...
 *     twig?: TwigConfig,
 *     recranet_twig_spreadsheet?: RecranetTwigSpreadsheetConfig,
