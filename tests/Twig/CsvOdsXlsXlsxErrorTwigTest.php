...
class CsvOdsXlsXlsxErrorTwigTest extends BaseTwigTest
{
    ...
    public function testStartCellIndexError($format)
    {
        ...
        $this->expectExceptionMessage('Argument 1 passed to Recranet\TwigSpreadsheetBundle\Wrapper\PhpSpreadsheetWrapper::startCell() must be of the type integer');
    ...
    {
        $this->expectException(\TypeError::class);
        $this->expectExceptionMessage('Argument 1 passed to Recranet\TwigSpreadsheetBundle\Wrapper\PhpSpreadsheetWrapper::startRow() must be of the type integer');
